...
// Sens par ID pour A, T1, T2 (verifie via tclarret 26/06/2026)
const SENS_PAR_ID = {
  30101:"A", 30459:"R",               // Perrache A
  42745:"R", 46049:"A",               // Ampere - Victor Hugo A
  32103:"A", 32102:"R",               // Perrache T1/T2
  34834:"A", 34835:"R",               // Place des Archives T1/T2
  34836:"A", 34837:"R",               // Sainte-Blandine T1/T2
  34874:"R", 34875:"A",               // Hotel Region T1/T2
  32138:"A",                          // IUT Feyssine T1
  46159:"A", 46160:"R",               // Debourg T1
  46154:"R", 35094:"A",               // Musee des Confluences T1
};

// Terminus theoriques forces — ignore la direction API
const TERMINUS = {
...
export default {
  async fetch(request, env) {
    ...
    try {
      const user = env?.GRANDLYON_USER || "demo";
      const pass = env?.GRANDLYON_PASS || "demo4dev";
